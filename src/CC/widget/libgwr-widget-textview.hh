...
#ifndef     __LIBGWR_WIDGET_TEXTVIEW_HH__
#define     __LIBGWR_WIDGET_TEXTVIEW_HH__
...
class GwrTextView
{
    ...
    class Model
    {
        ...
        private:
        gboolean                a_cursor_roves_initial_offset_memorized;
        gint                    a_cursor_roves_initial_offset;
        //  ====================================================================
        //  methods
        //  ====================================================================
        public:
        inline  GtkTextBuffer   *   textbuffer()
                                    {
        ...
        inline  TextTagHelper   *   text_tag_helper()
                ...
                gboolean            cursor_roves_initial_offset_memorized();
                void                cursor_roves_initial_offset_memorize();
                void                cursor_roves_initial_offset_recall();
                void                cursor_print();
        //  --------------------------------------------------------------------
        public:
         Model();
    ...
    class View
    {
        ...
        inline  GtkTextView     *   textview()
                                    {
                                        return GTK_TEXT_VIEW( d_gtk_text_view );
                                    }
        ...
        inline  GtkWidget       *   widget_textview()
                                    {
                                        return d_gtk_text_view;
                                    }
        //  --------------------------------------------------------------------
                void            buffer_disconnect();
                void            buffer_reconnect();
        //  --------------------------------------------------------------------
        //  cursor
        //  --------------------------------------------------------------------
        private:
    ...
    inline  void            cursor_roves_initial_offset_recall()
                            {
                                model()->cursor_roves_initial_offset_recall();
                            }
    //  ------------------------------------------------------------------------
    inline  void            buffer_disconnect()
                            {
                                view()->buffer_disconnect();
                            }
    inline  void            buffer_reconnect()
                            {
                                view()->buffer_reconnect();
                            }
    //  ------------------------------------------------------------------------
...
#endif                                                                          // #define __LIBGWR_WIDGET_TEXTVIEW_HH__
