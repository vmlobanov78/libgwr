...
gchar       FileData    [128];
//  ............................................................................
gchar           SampleText1 [1024];
gchar           SampleText2 [1024];
gchar           SampleText3 [1024];
...
void    Signal_button1_clicked(GtkWidget* _w, gpointer _data)
{
    ...
    {
        sprintf(SampleText1, "Line [%5i]:This is a sample text", i);
        sprintf(SampleText2, "Line [%5i]:This is a sample text with data", i);
        sprintf(SampleText3, "Line [%5i]:This is a sample text with data and url", i);
        ...
        if ( Use_colors )
        {
            ...
            //case    x   :   gwr_fast_text_buffer_add_line(tb1, SampleText, 2, 0, 0);    break;

            case    0   :   gwr_fast_text_buffer_add_line                   (tb1, SampleText1, 1, 0, 0);                            break;

            case    1   :   gwr_fast_text_buffer_add_line_with_data         (tb1, SampleText2, 2, 0, 0, SampleData, 12       );     break;

            //case    2   :   gwr_fast_text_buffer_add_line_with_data_and_url (tb1, SampleText3, 3, 0, 0, SampleData, 12, 40, 4 );    break;
            //case    2   :   gwr_fast_text_buffer_add_line(tb1, SampleText1, 3, 0, 0);    break;
            case    2   :   gwr_fast_text_buffer_add_line_with_data         (tb1, SampleText3, 3, 0, 0, SampleData, 12       );     break;

            }
        }
        else
        {
            gwr_fast_text_buffer_add_line(tb1, SampleText1, 0, 0, 0);
    ...
    Count++;
    gwr_fast_text_buffer_dump_mem( tb1 );
    gtk_fast_text_view_refresh( GTK_FAST_TEXT_VIEW(w_tv1) );
}
...
//  ............................................................................
void    GftvXdataCallback(gpointer _data,guint16 _len, guint16 ho, guint8 hl)
{
    GtkWidget   *   dialog;
    gchar           str1        [256];
    gchar           str2        [128];
...
int main( int argc, char *argv[])
{
    ...
    gtk_fast_text_view_set_color( GTK_FAST_TEXT_VIEW(w_tv1), 2, 0, 180, 0);
    gtk_fast_text_view_set_color( GTK_FAST_TEXT_VIEW(w_tv1), 3, 200, 200, 0);
