...
#include    "libgwr-array-data-multi.h"
        ...
        guint32                         _block_size   )
{
    ...
    b->d_mem            =   g_malloc0( _block_size );
    b->a_size           =   _block_size;
        ...
        guint32                         _block_size     )
{
    ...
    a->d_blocks         =   gwr_array_equal_new( GwrCADMBlock_S     , 20 );
    a->d_infos          =   gwr_array_equal_new( GwrCADMDataInfo_S  , 4096 );
    //  ........................................................................
    //  create  first GwrCADMBlock, this avoid some tests in
    //  gwr_array_data_multi_add_data()
    gwr_array_data_multi_block_alloc( &b, a->a_block_size );
    gwr_array_equal_add( a->d_blocks, &b );
    return a;
}
void
